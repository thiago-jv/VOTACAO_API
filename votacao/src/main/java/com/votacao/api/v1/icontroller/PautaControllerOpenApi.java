...
public interface PautaControllerOpenApi {
    ...
    @ApiResponses({
            @ApiResponse(code = 201, message = "Pauta cadastrado"),
    })
    ...
    @ApiResponses({
            @ApiResponse(code = 400, message = "Status de Pauta de Votação inválido", response = Problema.class),
    ...
    @ApiResponses({
            @ApiResponse(code = 400, message = "Status de Pauta de Votação fechado", response = Problema.class),
            @ApiResponse(code = 404, message = "Pauta de Votação não encontrado", response = Problema.class),
    })
